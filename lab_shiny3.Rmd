...
<i class="fas fa-exclamation-circle"></i> Please note the syntax with `input.countries` inside the `conditionalPanel()`. This is different from how you would normally use it as `input$countries` within the `server`. 
